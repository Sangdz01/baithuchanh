...
echo '<script language="javascript">alert("Đăng ký thành công!"); window.location="http://localhost/thuchanh/login.php";</script>';
...
if ($password != $row['password']) {
    header('Location: http://localhost/thuchanh/trangchu.php ');
} else {
